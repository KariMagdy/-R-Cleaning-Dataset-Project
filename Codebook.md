...
The data generated from running the run_analysis.R over the activity dataset available on :
http://archive.ics.uci.edu/ml/datasets/Human+Activity+Recognition+Using+Smartphones 

# Results contain the follwing columns 
[1] "Activity"                        "Subject_ID"                      "tBodyAcc.mean...X"               "tBodyAcc.mean...Y"              
